...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $pagodetalle->id_pagodetalles],
                ['confirm' => __('Are you sure you want to delete # {0}?', $pagodetalle->id_pagodetalles), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="pagodetalles form content">
            ...
            <fieldset>
                <legend><?= __('Edit Pagodetalle') ?></legend>
                <?php
